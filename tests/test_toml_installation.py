...
"""
        ...
        for plugin_dir in plugin_dirs:
            try:
                ...
                if os.path.exists(sensor_path):
                    # Check that sensor file contains load_plugin_config function
                    with open(sensor_path, 'r') as f:
                        content = f.read()
                        self.assertIn('load_plugin_config', content)
                        self.assertIn('plugin.toml', content)
                        
                    print(f"✅ {plugin_dir}/sensor.py has TOML configuration support")
    ...
    def test_toml_error_handling(self):
        ...
        # For now, we'll test that the sensors have proper error handling
        plugin_dirs = ['m8mulprc', 'm8prcsvr', 'm8refsvr', 'mstrsvr']
        ...
        for plugin_dir in plugin_dirs:
            ...
            if os.path.exists(sensor_path):
                ...
                print(f"✅ {plugin_dir}/sensor.py has error handling")
